...
export const OFFICIAL_CARDS: Card[] = [
  ...
  { id: 'elbow-1', name: 'Elbow', suits: ['Glove'], actions: [], abilities: [], specials: ['P'], points: 5, image: '/cards/Punchhelmet.png' },
  ...
  // ROW 4
  { id: 'centre-1', name: 'Centre', number: 6, suits: ['Stick'], actions: ['Move'], abilities: [], specials: [], points: 15, image: '/cards/Centrehelm.png' },
  { id: 'defenceman-1', name: 'Defenceman', number: 7, suits: ['Helmet'], actions: ['Intercept'], abilities: [], specials: [], points: 15, image: '/cards/Defencestick.png' },
  ...
  { id: 'superstar-1', name: 'Superstar', number: 8, suits: ['Stick', 'Glove'], actions: [], abilities: ['Purple'], specials: [], points: 30, image: '/cards/Superstarhelm.png' },
  ...
  { id: 'penaltykill-1', name: 'Penalty Kill', number: 12, suits: ['Helmet'], actions: [], abilities: [], specials: ['K'], points: 10, image: '/cards/Penaltykill.png' },
  ...
  { id: 'pokecheck-1', name: 'Poke Check', number: 3, suits: ['Stick'], actions: ['Poke-check'], abilities: ['Green'], specials: [], points: 10, image: '/cards/Pokehelmet.png' },
  ...
  { id: 'utility-plain', name: 'Utility', suits: ['Glove'], actions: [], abilities: [], specials: ['U'], points: 10, image: '/cards/Utility.png' },
  { id: 'rush-9', name: 'Rush 9', number: 9, suits: ['Skate'], actions: ['Move'], abilities: ['Orange'], specials: [], points: 12, image: '/cards/Rushhelmglove.png' },
  { id: 'rush-10', name: 'Rush 10', number: 10, suits: ['Skate'], actions: ['Move'], abilities: ['Orange'], specials: [], points: 15, image: '/cards/Rushhelmglove.png' },
  ...
  { id: 'goal', name: 'Goal', number: 0, suits: [], actions: ['Score'], abilities: ['Gold'], specials: [], points: 50, image: '/cards/Goalhelm.png' },
